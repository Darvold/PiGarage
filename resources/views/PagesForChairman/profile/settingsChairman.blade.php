@extends('layouts.mainChairman', ['ProfileSettingsChairman' => ['settingsChairman.css']])
@section('profile')
                        ...
                        <form method="post" action="{{route('settingsChairmanPost.store')}}">
                            ...
                            <div class="User_information">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="tel" pattern="[0-9\-]{1,10}" name="home_phone" title="Только цифры"
                                           maxlength="10" max="10" oninput="this.value=this.value.replace(/\D/g,'')"
                                           value="{{ formatHomePhoneNumber($user->home_phone) }}">
                                </div>
