@extends('layouts.profileChairman', ['ProfileConnectCoopStyles' => ['connectCoop.css', 'map_marker.css']])
...
<div class="main_block">
    <div class="main_head">
        <a href="{{route('ChairmanCreateMyCoop.index', ['id' => Auth::id()])}}" class="active">Поиск кооперативов</a>
    </div>
    <div class="main_body">
        <div class="center_width_container">
          ...
          <div class="button_marker">
            <a href="{{route('ProfileChairman.index', ['id' => Auth::id()])}}">Вернуться назад</a>
        </div>
