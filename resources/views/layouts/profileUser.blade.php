...
<div class="Head_border">
    <div class="Head_content">
        ...
        <div class="Block_Text_User" id="arrow_img">
            <span class="Text_user">Участник</span>
                ...
                <div id="hidden_element" class="div_block_to_arrow div_block_to_arrow_hidden">
                    <div class="flex_block">
                        <div class="text_button">
                            ...
                            <div class="right_block_text">
                                <a href="{{route('ProfileUser.index', ['id' => Auth::id()])}}" class="button_a">Профиль</a>
                            </div>
                        </div>
                    </div>
                    <div class="flex_block">
                        <div class="text_button">
                            ...
                            <div class="right_block_text">
                                <a href="{{route('UserConnectCoop.index', ['id' => Auth::id()])}}" class="button_a">Кооперативы</a>
                            </div>
                        </div>
                    </div>
                    <div class="flex_block">
                    ...
                    <div class="flex_block">
                        <div class="text_button">
                            ...
                            <div class="right_block_text">
                                <form action="{{route('logoutUser.store', ['id' => Auth::id()])}}" method="POST">
                                    @csrf
    ...
    <div class="left_block_navigation">
        <div class="text_button_navigation">
            ...
            <div class="right_block_text_navigation">
                <a href="{{route('ProfileUser.index', ['id' => Auth::id()])}}">Профиль</a>
            </div>
        </div>
        <div class="text_button_navigation">
            <div class="left_block_icon_navigation">
            ...
            <div class="right_block_text_navigation">
                <a href="{{route('UserConnectCoop.index', ['id' => Auth::id()])}}">Кооперативы</a>
            </div>
        </div>
        <div class="text_button_navigation">
            <div class="left_block_icon_navigation">
            ...
            <div class="right_block_text_navigation">
                <a href="{{route('Messages.index', ['id' => Auth::id()])}}">Сообщения</a>
            </div>
        </div>
        <div class="text_button_navigation">
            <div class="left_block_icon_navigation">
